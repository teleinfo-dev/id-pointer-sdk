...
public class ModifyValueIdRequest extends AbstractIdRequest {

    public HandleValue values[];

    public ModifyValueIdRequest(byte handle[], HandleValue value, AuthenticationInfo authInfo) {
        this(handle, new HandleValue[] { value }, authInfo);
    }

    public ModifyValueIdRequest(byte handle[], HandleValue values[], AuthenticationInfo authInfo) {
