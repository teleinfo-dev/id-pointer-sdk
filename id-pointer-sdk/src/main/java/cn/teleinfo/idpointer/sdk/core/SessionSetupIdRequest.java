...
public class SessionSetupIdRequest extends AbstractIdRequest {
    ...
    public SessionSetupIdRequest(int mode, byte[] publicKey) {
        super(Common.BLANK_HANDLE, AbstractMessage.OC_SESSION_SETUP, null);
    ...
    public SessionSetupIdRequest(byte exchangeKeyHandle[], int exchangeKeyIndex) {
        super(Common.BLANK_HANDLE, AbstractMessage.OC_SESSION_SETUP, null);
    ...
    public SessionSetupIdRequest(byte identityHandle[], int identityIndex, byte exchangeKeyHandle[], int exchangeKeyIndex) {
        super(Common.BLANK_HANDLE, AbstractMessage.OC_SESSION_SETUP, null);
     ...
     **/
    public SessionSetupIdRequest(int mode, byte identityHandle[], int identityIndex, byte publicKey[]) {
        super(Common.BLANK_HANDLE, AbstractMessage.OC_SESSION_SETUP, null);
        this.identityHandle = identityHandle;
        this.identityIndex = identityIndex;
        this.publicKey = publicKey;
     ...
     **/
    public SessionSetupIdRequest(int mode, byte identityHandle[], int identityIndex) {
        super(Common.BLANK_HANDLE, AbstractMessage.OC_SESSION_SETUP, null);
        keyExchangeMode = mode;
        this.identityIndex = identityIndex;
        this.identityHandle = identityHandle;
