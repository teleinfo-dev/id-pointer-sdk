 ...
 * used in resolution.
 */
public class ResolutionIdRequest extends AbstractIdRequest {
    ...
    public ResolutionIdRequest(byte handle[], byte reqTypes[][], int reqIndexes[], AuthenticationInfo authInfo) {
     ...
     * 添加构造方式，用于递归传输身份
     */
    public ResolutionIdRequest(byte handle[], byte reqTypes[][], int reqIndexes[], AuthenticationInfo authInfo, String authString) {
