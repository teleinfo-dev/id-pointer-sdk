...
public class DumpHandlesIdRequest extends AbstractIdRequest {
    ...
    public DumpHandlesIdRequest(byte rcvrHashType, int numServers, int serverNum, AuthenticationInfo authInfo) {
    ...
    public DumpHandlesIdRequest(byte rcvrHashType, int numServers, int serverNum, AuthenticationInfo authInfo, byte[] startingPoint, int startingPointType) {
