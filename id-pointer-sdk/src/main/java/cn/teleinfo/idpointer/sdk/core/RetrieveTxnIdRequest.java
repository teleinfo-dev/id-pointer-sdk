...
public class RetrieveTxnIdRequest extends AbstractIdRequest {
    ...
    public RetrieveTxnIdRequest(long lastTxnId, long lastQueryDate, byte rcvrHashType, int numServers, int serverNum, AuthenticationInfo authInfo) {
    ...
    public RetrieveTxnIdRequest(ReplicationStateInfo replicationStateInfo, byte rcvrHashType, int numServers, int serverNum, AuthenticationInfo authInfo) {
        super(Common.BLANK_HANDLE, OC_RETRIEVE_TXN_LOG, authInfo);
