...
public class CreateHandleIdRequest extends AbstractIdRequest {
    public HandleValue[] values;

    public CreateHandleIdRequest(byte[] handle, HandleValue[] values, AuthenticationInfo authInfo) {
        super(handle, AbstractMessage.OC_CREATE_HANDLE, authInfo);
        this.values = values;
        this.isAdminRequest = true;
    }

    public CreateHandleIdRequest(byte[] prefix, HandleValue[] values, AuthenticationInfo authInfo, boolean mintNewSuffix) {
