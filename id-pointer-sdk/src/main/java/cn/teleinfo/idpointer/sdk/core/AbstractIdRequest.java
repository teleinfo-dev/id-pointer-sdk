 ...
 */
public abstract class AbstractIdRequest extends AbstractMessage implements IdRequest {
    public byte handle[];
    ...
    public AbstractIdRequest(byte handle[], int opCode, AuthenticationInfo authInfo) {
        super(opCode);
    ...
    @Override
    public AbstractIdRequest clone() {
        AbstractIdRequest req = (AbstractIdRequest) super.clone();
    ...
    void takeValuesFromRequestActuallyUsed(AbstractIdRequest req) {
    ...
    @Override
    public void setRequestId(int nextInteger) {
        this.requestId = nextInteger;
    }
}
