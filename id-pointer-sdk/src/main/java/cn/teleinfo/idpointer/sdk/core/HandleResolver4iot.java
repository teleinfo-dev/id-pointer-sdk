 ...
 */
public class HandleResolver4iot implements RequestProcessor,HandleResolverInterface {
    ...
    public void setUseIPv6FastFallback(boolean ipv6FastFallback) {
        this.useIPv6FastFallback = ipv6FastFallback;
    }
...
//        }
        ...
        ClientSideSessionInfo csinfo = new ClientSideSessionInfo(-1, sessionKey, identityHandle, identityIndex, 0, server, response.majorProtocolVersion, response.minorProtocolVersion);
