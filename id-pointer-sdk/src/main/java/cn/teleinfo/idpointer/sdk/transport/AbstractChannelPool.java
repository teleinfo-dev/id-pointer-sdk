...
public abstract class AbstractChannelPool implements ChannelPool {
     ...
     */
    public AbstractChannelPool(Bootstrap bootstrap, final ChannelPoolHandler handler) {
     ...
     */
    public AbstractChannelPool(Bootstrap bootstrap, final ChannelPoolHandler handler, ChannelHealthChecker healthCheck) {
     ...
     */
    protected Future<Channel> acquireHealthyFromPoolOrNew(final Promise<Channel> promise) {
        try {
    ...
    protected void acquireNew(Promise<Channel> promise) {
        try {
    ...
    private void releaseAndOffer(Channel channel, Promise<Void> promise) throws Exception {
        if (offerChannel(channel)) {
            ...
            closeAndFail(channel, new AbstractChannelPool.ChannelPoolFullException(), promise);
        }
    }
