 ...
 ***********************************************************************/
public class ChallengeAnswerIdRequest extends AbstractIdRequest {
    ...
    public ChallengeAnswerIdRequest(byte authType[], byte userIdHandle[], int userIdIndex, byte signedResponse[], AuthenticationInfo authInfo) {
    ...
    public ChallengeAnswerIdRequest(AbstractIdRequest req, ChallengeIdResponse challenge, AuthenticationInfo authInfo) throws HandleException {
