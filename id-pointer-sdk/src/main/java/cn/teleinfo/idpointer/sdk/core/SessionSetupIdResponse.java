...
public class SessionSetupIdResponse extends AbstractIdResponse {
    ...
    public SessionSetupIdResponse(int mode, byte data[]) {
        super(OC_SESSION_SETUP, AbstractMessage.RC_SUCCESS);
        this.data = data;
        this.keyExchangeMode = mode;
    }

    public SessionSetupIdResponse(SessionSetupIdRequest req, byte data[]) throws HandleException {
