 ...
 ***********************************************************************/
public class ChallengeAnswerIdisIdRequest extends AbstractIdRequest {
    public byte authType[];
    public byte userIdHandle[];
    public int userIdIndex;
    public byte signedResponse[];
    public AbstractIdRequest originalRequest; // only used by client

    public ChallengeAnswerIdisIdRequest(byte authType[], byte userIdHandle[], int userIdIndex, byte signedResponse[], AuthenticationInfo authInfo) {
    ...
    public ChallengeAnswerIdisIdRequest(AbstractIdRequest req, ChallengeIdResponse challenge, AuthenticationInfo authInfo) throws HandleException {
