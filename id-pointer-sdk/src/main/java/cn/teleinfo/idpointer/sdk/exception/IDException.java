...
public class IDException extends Exception {
    ...
    /**
     * 响应的返回响不是成功,RC_SUCCESS不是1
     */
    public static final int RC_INVALID_RESPONSE_CODE = 2003;

    /**
     * 异步消息响应超时
     */
    public static final int PROMISE_GET_ERROR = 3000;
    ...
    public IDException(int code, AbstractResponse response) {
        this.code = code;
        this.response = response;
    }

    public IDException(int code, String message, AbstractResponse response) {
        super(message);
        this.code = code;
        this.response = response;
    }

    public IDException(int code, String message, Throwable cause, AbstractResponse response) {
        super(message, cause);
        this.code = code;
        this.response = response;
    }

    public IDException(int code, Throwable cause, AbstractResponse response) {
        super(cause);
        this.code = code;
        this.response = response;
    }
