...
class IDClientSm2PubkeyTest {
    ...
    void sm2UserInit() throws Exception {
        ...
        System.out.println(Hex.encodeHexString(handleValue.getData()));
        idClient.deleteHandle("88.888.1024/sm2user1");
        idClient.createHandle("88.888.1024/sm2user1",new HandleValue[]{handleValue});
    ...
    void sm2UserResolve() throws IDException {
        ValueHelper valueHelper = ValueHelper.getInstance();
        idClient.resolveHandle("88.888.1024/sm2user1");
    }

    @Test
    void sm2UserLogin() throws Exception {
        System.out.println(sm2UserPublicKeyPem);
        //InetSocketAddress inetSocketAddress = new InetSocketAddress("10.14.3.2", 2641);
        ...
        AuthenticationInfo authenticationInfo = new PublicKeyAuthenticationInfo(Util.encodeString("88.888.1024/sm2user1"), 300, privateKey);

        IDClient idClient1 = idClientFactory.newInstance(inetSocketAddress, authenticationInfo,true);

        idClient1.resolveHandle("88.888.1024/sm2user1");
    }
